  ...
  return (
    <div className='mt-3'>
      ...
      {commentState.comments.map((comment : CommentData)=>{
        return(
          <div className='comment my-3 bg-slate-400 rounded p-3' key={`${comment.owner}-${comment.createdAt}`} >
            ...
            <p className='text-sm text-gray-700 font-semibold'>{dateFormatter.format(new Date(comment.createdAt))}</p>
